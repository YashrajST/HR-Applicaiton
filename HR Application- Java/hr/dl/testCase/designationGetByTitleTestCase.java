...
import java.util.*;
class designationGetByTitleTestCasepsp
{
...
System.out.println("-----------------------Using GetByTitle--------------------------------");
System.out.print("Enter title : ");
DesignationDTOInterface designation=designationDAO.getByTitle(Keyboard.getString());
System.out.println(designation.getCode()+" -> "+designation.getTitle());
